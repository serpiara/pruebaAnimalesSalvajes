...
// Busca la imagen del animal seleccionado en el select y la muestra en el campo animal
...
// Se pinta la previsualizacion de la imagen en el campo de preview    
    ...
    document.getElementById('Animales').innerHTML= `<img src = "../assets/imgs/${tipoAnimal.imagen}")>`;
});
...
// Boton Agregar debe enviar los datos del arreglo y mostrar en el area de anilaes en investigacion
    ...
    document.getElementById('Animales').innerHTML= "ACA";
